---
title: "Porter's Five Forces: A Complete Guide to Industry and Competitive Analysis"
desc: "Learn Porter's Five Forces framework, including competitive rivalry, threat of new entrants, substitutes, supplier power, and buyer power, with an airline industry example."
keywords:
...
2. **Customer willingness to switch**
...
1. **Rivalry among existing competitors** — measures the intensity of competition between current players.
2. **Threat of new entrants** — examines how easily new competitors can enter the market.
3. **Threat of substitutes** — identifies alternative solutions that satisfy the same customer need.
4. **Bargaining power of suppliers** — evaluates suppliers' ability to influence prices, quality, and terms.
5. **Bargaining power of buyers** — measures customers' ability to influence price, quality, and purchasing conditions.
